...
const nnuSuiyuan: Campus = {
  ...
  facts: {
    ...
    offCampusAllowed: true,
    scholarshipNote: "国际中文教师奖学金（原孔子学院奖学金）覆盖大部分语言进修生和汉语国际教育硕士，江苏省政府奖学金和 CSC 主要给学位生。",
    applicationWindow: "语言进修生每学期都收，秋季学位生 12 月至 5 月",
    website: "https://www.njnu.edu.cn",
  },
  tagline: "民国建筑里学中文，出校门就是市区",
  taglineEn: "Learn Chinese among 1920s buildings, downtown at the gate",
  summary:
    "南师大的语言生、交换生和汉语国际教育专业几乎都在随园。校区是 1923 年金陵女子大学的老园子，绿琉璃瓦加法国梧桐，「中国最美校园」不是客气话。它小到 10 分钟能走遍，出宁海路就是颐和路公馆区和上海路的咖啡馆，走到新街口 35 分钟。代价是宿舍老、床位少、没有像样的运动场，而且没有地方再盖新楼。",
  ...
  neighborhoods: [
    {
      name: "宁海路 / 颐和路",
      nameEn: "Ninghai Rd & Yihe Rd",
      vibe: "民国公馆区，梧桐、小院、咖啡馆，租的都是老房子",
      rentCny: [3000, 4800],
      commute: "走路 5-10 分钟到校门",
      goodFor: ["想住进电影里", "预算宽松", "不介意老房子"],
      watchOut: "老房子隔音差、没电梯、冬天漏风，看房时把空调和热水器都开一遍。",
    },
    {
      name: "上海路 / 广州路",
      nameEn: "Shanghai Rd & Guangzhou Rd",
      vibe: "南大和南师大中间的学生街，酒吧、书店、深夜食堂",
      rentCny: [2600, 4000],
      commute: "走路 10 分钟",
      goodFor: ["夜生活", "想认识南大的人", "第一年"],
      watchOut: "临街的房子周五晚上很吵。",
    },
    {
      name: "龙江 / 草场门",
      nameEn: "Longjiang",
      vibe: "老居民区，菜场和小饭馆便宜，住的多是本地家庭",
      rentCny: [2200, 3200],
      commute: "地铁 4 号线两站，或骑车 15 分钟",
      goodFor: ["省钱", "想安静", "带家属"],
    },
  ],
  spots: [
  ...
  transport: [
    ...
    { to: "南京南站", toEn: "Nanjing South Rail", mode: "metro", minutes: 35, cny: 4, note: "走 15 分钟到鼓楼站，1 号线直达" },
    { to: "禄口国际机场", toEn: "Lukou Airport", mode: "metro", minutes: 75, cny: 8, note: "1 号线到南京南站换 S1，行李多就打车，150 元左右" },
    { to: "玄武湖", toEn: "Xuanwu Lake", mode: "bike", minutes: 15, cny: 2, note: "共享单车沿北京西路一路向东，湖边跑步和野餐都不要钱" },
  ],
  pros: [
    "校区在鼓楼区正中，走路就能到上海路、颐和路，进新街口不用等地铁",
    "语言生和交换生占比高，国际文化教育学院对零基础学生的流程很熟",
    "民国建筑加满园梧桐，秋天在校园里走一圈就值回机票",
    "南大鼓楼校区就在马路对面，两校的留学生活动基本互通",
  ],
  cons: [
    "宿舍是老楼，独卫和电梯都不能指望，热水器要错峰用",
    "校区太小，没有健身房和游泳馆，想运动得去校外花钱",
    "床位紧，语言生不一定能分到宿舍，很多人开学第一周就得找房",
    "冬天没有暖气，老楼的窗户漏风，空调制热效果比新校区差得多",
  ],
  faq: [
    { q: "零基础可以报语言班吗？", a: "可以，国际文化教育学院每学期都开零起点班，按入学测试分级。一学期学费 9000 元左右，一学年 17000 元上下，开学两周内可以调班。" },
    { q: "住不进宿舍怎么办？", a: "学院会给一份合作公寓和中介的名单，上海路、宁海路一带一居室 2600-4000 元。签约后 24 小时内带合同和房东身份证复印件去派出所做住宿登记，这一步别拖。" },
    { q: "随园和仙林校区怎么区分？", a: "南师大本科生大部分在仙林校区，随园主要是研究生、语言生和部分文科院系。录取通知书上写的校区就是你报到和上课的校区，两边隔了 20 公里，别跑错。" },
    { q: "在随园学中文，进步会比其他学校快吗？", a: "教材和课时差不多，差别在于随园出门就是市区，买菜、点单、坐车都是在用中文。想练口语的人一般选这里，不想说中文的人在这会比较累。" },
  ],
};
...
const hhuJiangning: Campus = {
  ...
  facts: {
    ...
    dormGuaranteed: true,
    offCampusAllowed: true,
    scholarshipNote: "CSC「一带一路」专项、水利部和商务部的援外项目、江苏省政府奖学金是主力，全奖比例在南京高校里少见地高，但名额集中在水利、土木、环境。",
    applicationWindow: "秋季入学 12 月至 4 月，CSC A 类要走本国使馆，1 月前就得动手",
    website: "https://www.hhu.edu.cn",
  },
  tagline: "水利工程世界第一档，一带一路奖学金生的大本营",
  taglineEn: "Top-tier hydraulic engineering, home base of the Belt and Road scholars",
  summary:
    "河海是水利部背景的工科校，水利工程在各种学科排名里都是世界第一档，土木、环境、电气也强。留学生绝大多数在江宁校区，其中一大半拿着中国政府「一带一路」类奖学金，巴基斯坦、埃塞俄比亚、哈萨克斯坦、孟加拉国的同学一抓一大把。校门口是地铁 S1「河海大学·佛城西路」站，两站到南京南站，进新街口要 55 分钟。校园安静到周末像放假。",
  ...
  neighborhoods: [
    {
      name: "佛城西路校门口",
      nameEn: "Focheng West Road",
      vibe: "大学城边缘的居民小区，房子新、价格低，吃饭靠外卖和小超市",
      rentCny: [1500, 2400],
      commute: "走路 5-10 分钟",
      goodFor: ["省钱", "合租", "研究生"],
      watchOut: "晚上九点后街上没什么人，小卖部也关得早。",
    },
    {
      name: "江宁大学城（方山）",
      nameEn: "Jiangning University Town",
      vibe: "七八所高校围着方山，学生街、奶茶店、网吧，比河海门口热闹",
      rentCny: [1700, 2600],
      commute: "骑车 15 分钟，或公交 3 站",
      goodFor: ["想认识其他学校的人", "第一年"],
    },
    {
      name: "百家湖 / 胜太路",
      nameEn: "Baijiahu",
      vibe: "江宁最成熟的商圈，商场、电影院、健身房都有",
      rentCny: [2300, 3500],
      commute: "S1 到南京南站换 1 号线，35 分钟",
      goodFor: ["受不了大学城的安静", "常聚餐"],
      watchOut: "每天通勤要换乘，赶早八很痛苦。",
    },
  ],
  spots: [
  ...
  transport: [
    ...
    { to: "南京南站", toEn: "Nanjing South Rail", mode: "metro", minutes: 12, cny: 2, note: "S1 直达，两站" },
    { to: "禄口国际机场", toEn: "Lukou Airport", mode: "metro", minutes: 25, cny: 5, note: "S1 反方向直达机场，是南京所有校区里到机场最快的" },
    { to: "河海大学鼓楼校区", toEn: "Hohai Gulou Campus", mode: "metro", minutes: 65, cny: 6, note: "S1 转 1 号线到鼓楼站再走 15 分钟，部分院系的答辩和讲座在老校区" },
  ],
  pros: [
    "水利、土木、环境的全英文硕博项目多，导师带国际生的经验丰富",
    "全奖比例高，CSC 和一带一路专项名额集中在这里",
    "留学生规模大，巴基斯坦、埃塞、哈萨克斯坦的学生会都很活跃，节日不愁没人过",
    "地铁 S1 在校门口，两站到南京南站，25 分钟到禄口机场",
  ],
  cons: [
    "校区在江宁南部，进新街口单程 55 分钟起，还要换乘",
    "几乎全是工科，校园文化偏理工，文艺活动少",
    "周边太安静，晚上九点以后校门外基本没店开着",
    "奖学金生集中意味着开学季行政窗口极度拥挤，报到排队两小时是常态",
  ],
  faq: [
    { q: "CSC 生活费什么时候到账？", a: "一般报到、体检和银行卡都办完后的下个月 15 号前后到账，第一笔可能拖到 10 月底。开卡一定要开国际教育学院指定的那家银行，开错行钱进不来。" },
    { q: "全英文项目的课真的全英文吗？", a: "课件和考试是英文，但导师组会和实验室日常大量用中文。研究生第一年选一门中文课，两年后基本能听懂组会。" },
    { q: "巴基斯坦和非洲学生多，会不会形成小圈子？", a: "会。同乡群体大是好事也是坏事，想练中文和认识中国同学的人要主动加入学院的社团和球队。" },
    { q: "江宁校区和鼓楼校区怎么分？", a: "本科生和大部分硕博在江宁，少数文科和商科在市区的鼓楼校区（西康路）。看录取通知书上的校区，两边坐地铁要一小时以上。" },
  ],
};
...
const njustXiaolingwei: Campus = {
  ...
  facts: {
    ...
    campusName: "孝陵卫校区",
    campusNameEn: "Xiaolingwei Campus",
    foundedYear: 1953,
    ...
    dormGuaranteed: true,
    offCampusAllowed: true,
    scholarshipNote: "CSC 和江苏省政府奖学金都有，但涉及国防背景的专业不对留学生开放，申请前先在国际教育学院官网核对当年的招生专业目录。",
    applicationWindow: "秋季入学 1 月至 5 月",
    website: "https://www.njust.edu.cn",
  },
  tagline: "兵器工科强校，校门口是中山陵和地铁 2 号线",
  taglineEn: "Defence-engineering roots, metro line 2 and the Ming tombs at the gate",
  summary:
    "南理工从哈军工炮兵工程系一路演变过来，兵器、材料、机械、自动化是家底。校区在紫金山南麓，隔一条马路就是明孝陵和中山陵景区，地铁 2 号线孝陵卫站到新街口只要 15 分钟，是南京大校区里位置最好的一个。每年三月底校园里成片的二月兰开花，全城的人都来拍照。要注意的是不少专业不对留学生开放，而且开放的大部分是中文授课。",
  ...
  neighborhoods: [
    {
      name: "孝陵卫 / 钟灵街",
      nameEn: "Xiaolingwei",
      vibe: "老居民区加学生街，小饭馆和水果店多，房租不贵",
      rentCny: [2200, 3200],
      commute: "走路 5-10 分钟到校门",
      goodFor: ["第一年", "省钱", "想离地铁近"],
      watchOut: "老小区没电梯，六楼的房子夏天很热。",
    },
    {
      name: "苜蓿园 / 卫岗",
      nameEn: "Muxuyuan",
      vibe: "更靠城里一点，卫岗牛奶的总部就在这，安静的老城东",
      rentCny: [2600, 3800],
      commute: "地铁 2 号线两站，或骑车 12 分钟",
      goodFor: ["研究生", "想住得离市区近点"],
    },
    {
      name: "马群 / 百水桥",
      nameEn: "Maqun",
      vibe: "城东的通勤住宅区，新小区多，价格比城里低一档",
      rentCny: [2000, 3000],
      commute: "地铁 2 号线两站",
      goodFor: ["合租", "带家属", "预算紧"],
      watchOut: "马群站是换乘站，早高峰地铁挤得上不去。",
    },
  ],
  spots: [
  ...
  transport: [
    ...
    { to: "南京南站", toEn: "Nanjing South Rail", mode: "metro", minutes: 35, cny: 4, note: "2 号线到新街口换 1 号线，或到大行宫换 3 号线" },
    { to: "中山陵 / 明孝陵", toEn: "Sun Yat-sen Mausoleum & Ming Tombs", mode: "bike", minutes: 15, cny: 0, note: "往下马坊方向骑，中山陵免票，明孝陵学生半价，樱花季人多得走不动" },
    { to: "禄口国际机场", toEn: "Lukou Airport", mode: "metro", minutes: 70, cny: 8, note: "2 号线到新街口换 1 号线到南京南站再换 S1，行李多就打车，180 元左右" },
  ],
  pros: [
    "地铁 2 号线孝陵卫站在校门口，15 分钟到新街口，大校区里没有更好的位置",
    "背靠紫金山，中山陵、明孝陵、梅花山都是散步范围，三月的二月兰和梅花是全城的打卡点",
    "机械、材料、自动化的实验室条件好，工科研究生的科研资源充足",
    "宿舍区和教学区集中，校园虽大但日常生活半径小",
  ],
  cons: [
    "兵器、武器系统等涉及国防的专业不对留学生开放，选专业前必须核对国际教育学院的清单",
    "开放的专业里中文授课占多数，全英文项目远少于东大和河海",
    "留学生规模在南京的 211 里偏小，国际生圈子不大，靠自己出去混",
    "留学生公寓楼新旧差别大，分到老楼就没电梯，夏天顶楼很热",
  ],
  faq: [
    { q: "哪些专业留学生不能报？", a: "涉及兵器、武器系统、部分材料和信息安全方向的专业不招留学生，实验室也进不去。国际教育学院每年发布的招生专业目录是唯一准绳，网上的旧信息别信。" },
    { q: "二月兰到底什么时候开？", a: "一般 3 月下旬到 4 月中旬，清明前后最盛。开花的两个周末校园会限流，外校的人要预约进校，自己的校园卡随时能进。" },
    { q: "不会中文能读中文授课的专业吗？", a: "不建议。学校要求 HSK 4 起，实际上课 HSK 5 以下会很吃力。先读一年汉语进修再入专业是常见路线，语言课在同一个校区。" },
    { q: "住校外方便吗？", a: "孝陵卫和钟灵街一带一居室 2200-3200 元，走路到校门 10 分钟内，是南京主城里少见的便宜又近地铁的组合。签约后 24 小时内去派出所登记。" },
  ],
};
...
const njmuJiangning: Campus = {
  ...
  facts: {
    ...
    dormGuaranteed: true,
    offCampusAllowed: true,
    scholarshipNote: "MBBS 基本是自费项目，奖学金很少；硕博和少数成绩靠前的 MBBS 学生能拿到江苏省政府奖学金或校级奖学金。",
    applicationWindow: "MBBS 秋季入学 3 月至 7 月，硕博 CSC 项目 1 月至 4 月",
    website: "https://www.njmu.edu.cn",
  },
  tagline: "全英文 MBBS，南亚和非洲医学生的首选",
  taglineEn: "English-taught MBBS, the first pick for South Asian and African med students",
  summary:
    "南医大的留学生几乎全是六年制 MBBS，全程英文授课，印度、巴基斯坦、尼泊尔、孟加拉国和非洲的学生占九成。基础课在江宁校区，临床课和见习实习在江苏省人民医院、南京市第一医院这些附属医院。课表密到每天早八晚五，出勤率不够直接取消考试资格。校门口是地铁 1 号线「南医大·江苏经贸学院」站，进新街口 50 分钟，不用换乘但要坐 17 站。",
  ...
  neighborhoods: [
    {
      name: "龙眠大道校门口",
      nameEn: "Longmian Avenue, campus gate",
      vibe: "大学城的学生街，奶茶、水果、小饭馆，晚上十点收摊",
      rentCny: [1500, 2300],
      commute: "走路 5-10 分钟",
      goodFor: ["省钱", "合租"],
      watchOut: "MBBS 低年级基本住校，住校外要先向国际教育学院备案。",
    },
    {
      name: "江宁大学城（方山）",
      nameEn: "Jiangning University Town",
      vibe: "十来所学校的学生街，比南医大门口热闹一档",
      rentCny: [1600, 2500],
      commute: "地铁 1 号线两站，或骑车 15 分钟",
      goodFor: ["想认识其他学校的人", "第一年"],
    },
    {
      name: "百家湖 / 胜太路",
      nameEn: "Baijiahu",
      vibe: "江宁最成熟的商圈，商场、电影院、健身房",
      rentCny: [2300, 3500],
      commute: "地铁 1 号线 20 分钟",
      goodFor: ["高年级", "受不了大学城"],
      watchOut: "早八的课要六点半起床。",
    },
  ],
  ...
  transport: [
    ...
    { to: "南京南站", toEn: "Nanjing South Rail", mode: "metro", minutes: 22, cny: 4, note: "1 号线 9 站直达" },
    { to: "江苏省人民医院", toEn: "Jiangsu Province Hospital (teaching hospital)", mode: "metro", minutes: 65, cny: 6, note: "临床阶段的主战场，在鼓楼区广州路，1 号线进城换 2 号线；高年级很多人干脆搬到市区" },
    { to: "禄口国际机场", toEn: "Lukou Airport", mode: "metro", minutes: 40, cny: 6, note: "1 号线到南京南站换 S1；打车 25 分钟，80 元左右" },
  ],
  pros: [
    "MBBS 六年全英文授课，教材、考试、行政通知都是英文，不会中文也能顺利毕业",
    "附属医院多，省人民医院、市第一医院都是三甲，临床见习的病例量巨大",
    "南亚和非洲学生的社群成熟，开学有老生带，排灯节和开斋节都有人组织",
    "江宁校区新，宿舍标配空调独卫，生活成本是南京最低一档",
  ],
  cons: [
    "课表每天早八晚五，出勤率低于要求直接取消考试资格，没有「翘课」这个选项",
    "回国后的执业资格考试（印度的 FMGE、巴基斯坦的 PMDC 考试等）学校不负责，过不过全看自己",
    "临床阶段要跟着中国医生查房，病人不会说英文，毕业前 HSK 4 是硬要求",
    "校区在江宁南部，进新街口 50 分钟，前两年基本围着校园转",
  ],
  faq: [
    { q: "MBBS 学费和住宿一年多少？", a: "学费 3 万多一年，以录取通知书为准；双人间宿舍约 1000 元一个月，加保险 800 元和体检 538 元。第一年准备好 5 万元左右的现金流最稳妥。" },
    { q: "毕业后回国能直接行医吗？", a: "不能直接。印度要过 FMGE（正在向 NExT 过渡），巴基斯坦要过 PMDC 的考试，尼泊尔和孟加拉国也各有执照考试。学校提供成绩单和认证材料，但复习和报名全靠自己，大五开始就要准备。" },
    { q: "考勤到底多严？", a: "每节课点名，缺勤超过规定比例直接取消该门课的考试资格，重修要交费。请假必须提前走国际教育学院的流程，事后补假基本不批。" },
    { q: "临床阶段住哪里？", a: "见习实习在市区的附属医院，往返江宁单程一小时以上，很多人这个阶段搬到医院附近合租。住宿安排每年不一样，以国际教育学院的通知为准，提前问高年级的同学。" },
  ],
};
